...
<div class="page-wrapper">
    ...
    <header class="main-header">
			...
			<div class="auto-container">
				<div class="inner-container d-flex justify-content-between align-items-center">
					...
					<div class="logo-box d-flex align-items-center">
						...
						<!-- Logo -->
						<div class="logo"><a href="index.html"><img src="../front/images/logo.png" alt="" title=""></a></div>
					</div>
        ...
        <div class="sticky-header">
            <div class="auto-container">
				<div class="d-flex justify-content-between align-items-center">
					<!-- Logo -->
					<div class="logo">
						<a href="index.html" title=""><img src="../front/images/logo-small.png" alt="" title=""></a>
					</div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="../front/images/mobile-logo.png" alt="" title=""></a></div>
				<!-- Search -->
		...
		<div class="auto-container">
			...
			<div class="footer-bottom">
				<div class="d-flex justify-content-between align-items-center flex-wrap">
					...
					<div class="cards"><img src="../front/images/icons/cards.png" alt="" /></div>
				</div>
			</div>
